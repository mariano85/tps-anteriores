...
char* getDescription(int item){
	...
	case    CPU_TO_MSP_GUARDA_CADENA: return "CPU_TO_MSP_GUARDA_CADENA";
	...
	case    CPU_TO_KERNEL_BLOQUEO_INNC : return "CPU_TO_KERNEL_BLOQUEO_INNC";
	case    CPU_TO_MSP_PUSH : return "CPU_TO_MSP_PUSH";
	case    CPU_TO_MSP_TAKE : return "CPU_TO_MSP_TAKE";
	case    CPU_TO_KERNEL_BLOQUEO_OUTN : return "CPU_TO_KERNEL_BLOQUEO_OUTN";
