...
char* getDescription(int item){
	...
	case	KERNEL_TO_CPU_HANDSHAKE:	return 	"KRN_TO_CPU_HANDSHAKE "	;
	case	KERNEL_TO_CPU_TCB:	return 	"KRN_TO_CPU_TCB"	;
	case	KERNEL_TO_CPU_VAR_COMPARTIDA_OK:	return 	"KRN_TO_CPU_VAR_COMPARTIDA_OK "	;
	case	KERNEL_TO_CPU_VAR_COMPARTIDA_ERROR:	return 	"KRN_TO_CPU_VAR_COMPARTIDA_ERROR "	;
	case	KERNEL_TO_CPU_ASIGNAR_OK:	return 	"KRN_TO_CPU_ASIGNAR_OK "	;
	case	KERNEL_TO_CPU_BLOCKED:	return 	"KRN_TO_CPU_BLOCKED "	;
	case	KERNEL_TO_CPU_OK:	return 	"KRN_TO_CPU_OK "	;
	case	KERNEL_TO_CPU_TCB_QUANTUM:	return 	"KRN_TO_CPU_PCB_QUANTUM "	;
	case	KERNEL_TO_PRG_IMPR_PANTALLA:	return 	"KRN_TO_PRG_IMPR_PANTALLA "	;
	case	KERNEL_TO_PRG_IMPR_IMPRESORA:	return 	"KRN_TO_PRG_IMPR_IMPRESORA "	;
	case	KERNEL_TO_PRG_END_PRG:	return 	"KRN_TO_PRG_END_PRG "	;
	case	KERNEL_TO_PRG_NO_MEMORY:	return 	"KRN_TO_PRG_NO_MEMORY "	;
	case	KERNEL_TO_MSP_MEM_REQ:	return 	"KRN_TO_UMV_MEM_REQ "	;
	case	KERNEL_TO_MSP_ELIMINAR_SEGMENTOS:	return 	"KRN_TO_UMV_ELIMINAR_SEGMENTOS "	;
	case	KERNEL_TO_MSP_HANDSHAKE:	return 	"KRN_TO_UMV_HANDSHAKE "	;
	case	KERNEL_TO_MSP_ENVIAR_BYTES:	return 	"KRN_TO_UMV_ENVIAR_BYTES "	;
	case	KERNEL_TO_MSP_ENVIAR_ETIQUETAS:	return 	"KRN_TO_UMV_ENVIAR_ETIQUETAS "	;
	case	KERNEL_TO_MSP_SOLICITAR_BYTES:	return 	"KRN_TO_UMV_SOLICITAR_BYTES "	;
	case	CON_TO_KRN_HANDSHAKE:	return 	"CON_TO_KRN_HANDSHAKE "	;
	case	CON_TO_KRN_CODE:	return 	"CON_TO_KRN_CODE "	;
	case	CON_TO_KRN_OK:	return 	"CON_TO_KRN_OK "	;
	case	CPU_TO_MSP_INDICEYLINEA:	return 	"CPU_TO_UMV_INDICEYLINEA "	;
	case	CPU_TO_MSP_HANDSHAKE:	return 	"CPU_TO_UMV_HANDSHAKE "	;
	case	CPU_TO_MSP_CAMBIO_PROCESO:	return 	"CPU_TO_UMV_CAMBIO_PROCESO "	;
	case	CPU_TO_MSP_SOLICITAR_BYTES:	return 	"CPU_TO_UMV_SOLICITAR_BYTES "	;

	case    CPU_TO_MSP_ENVIAR_BYTES: return "CPU_TO_UMV_ENVIAR_BYTES";
	case	CPU_TO_KERNEL_HANDSHAKE:	return 	"CPU_TO_KRN_HANDSHAKE "	;
	case	CPU_TO_KERNEL_NEW_CPU_CONNECTED:	return 	"CPU_TO_KRN_NEW_CPU_CONNECTED "	;
	case	CPU_TO_KERNEL_END_PROC:	return 	"CPU_TO_KRN_END_PROC "	;
	case	CPU_TO_KERNEL_FINALIZO_QUANTUM_NORMALMENTE:	return 	"CPU_TO_KRN_END_PROC_QUANTUM "	;
	case	CPU_TO_KERNEL_END_PROC_QUANTUM_SIGNAL: return "CPU_TO_KRN_END_PROC_QUANTUM_SIGNAL";
	case 	CPU_TO_KERNEL_END_PROC_ERROR:		return "CPU_TO_KRN_END_PROC_ERROR";
	case	CPU_TO_KERNEL_IMPRIMIR:	return 	"CPU_TO_KRN_IMPRIMIR "	;
	case	CPU_TO_KERNEL_IMPRIMIR_TEXTO:	return 	"CPU_TO_KRN_IMPRIMIR_TEXTO "	;
	case	CPU_TO_KERNEL_OK:	return 	"CPU_TO_KRN_OK "	;
	case	MSP_TO_KERNEL_MEMORY_OVERLOAD:	return 	"MSP_TO_KRN_MEMORY_OVERLOAD "	;
	case	MSP_TO_KERNEL_SEGMENTO_CREADO:	return 	"MSP_TO_KRN_SEGMENTO_CREADO "	;
	case	MSP_TO_KERNEL_ENVIO_BYTES:	return 	"MSP_TO_KRN_ENVIO_BYTES "	;
	case	MSP_TO_KERNEL_HANDSHAKE_OK:	return 	"MSP_TO_KRN_HANDSHAKE_OK "	;
