...
char* getDescription(int item){
	...
	case	KRN_TO_CPU_TCB:	return 	"KRN_TO_CPU_TCB"	;
	...
	case	KRN_TO_MSP_MEM_REQ:	return 	"KRN_TO_UMV_MEM_REQ "	;
	case	KRN_TO_MSP_ELIMINAR_SEGMENTOS:	return 	"KRN_TO_UMV_ELIMINAR_SEGMENTOS "	;
	case	KRN_TO_MSP_HANDHAKE:	return 	"KRN_TO_UMV_HANDHAKE "	;
	case	KRN_TO_MSP_ENVIAR_BYTES:	return 	"KRN_TO_UMV_ENVIAR_BYTES "	;
	case	KRN_TO_MSP_ENVIAR_ETIQUETAS:	return 	"KRN_TO_UMV_ENVIAR_ETIQUETAS "	;
	case	KRN_TO_MSP_SOLICITAR_BYTES:	return 	"KRN_TO_UMV_SOLICITAR_BYTES "	;
	...
	case	CPU_TO_MSP_SOLICITAR_ETIQUETAS:	return 	"CPU_TO_UMV_SOLICITAR_ETIQUETAS "	;
